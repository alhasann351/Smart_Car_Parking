...
public class SlotAdapter extends RecyclerView.Adapter<SlotAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(slotModel.getStatus().equals("Unavailable")){
            //holder.bookNow.setActivated(false);
            //holder.bookNow.setClickable(false);
            //holder.bookNow.setEnabled(false);
            ...
            holder.bookNow.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), Slot_Booking_Activity.class);
